...
// Complete list of auto parts with stock status
export const AUTO_PARTS_INVENTORY = [
  { name: "Engine", slug: "engine", status: "In Stock", category: "engines" },
  { name: "Transmission", slug: "transmission", status: "In Stock", category: "transmissions" },
  { name: "Transfer Case", slug: "transfer-case", status: "In Stock", category: "drivetrain" },
  { name: "ABS", slug: "abs", status: "In Stock", category: "brakes" },
  { name: "ABS Pump", slug: "abs-pump", status: "In Stock", category: "brakes" },
  { name: "AC Compressor", slug: "ac-compressor", status: "In Stock", category: "cooling" },
  { name: "AC Condenser", slug: "ac-condenser", status: "In Stock", category: "cooling" },
  { name: "AC Evaporator", slug: "ac-evaporator", status: "In Stock", category: "cooling" },
  { name: "Air Flow Meter", slug: "air-flow-meter", status: "In Stock", category: "electrical" },
  { name: "Anti Lock Braking System", slug: "anti-lock-braking-system", status: "In Stock", category: "brakes" },
  { name: "Axle Assembly Front", slug: "axle-assembly-front", status: "In Stock", category: "drivetrain" },
  { name: "Axle Assembly Rear", slug: "axle-assembly-rear", status: "In Stock", category: "drivetrain" },
  { name: "Axle Beam", slug: "axle-beam", status: "In Stock", category: "drivetrain" },
  { name: "Axle Shaft", slug: "axle-shaft", status: "In Stock", category: "drivetrain" },
  { name: "Bell Housing", slug: "bell-housing", status: "In Stock", category: "transmissions" },
  { name: "Blower Motor", slug: "blower-motor", status: "In Stock", category: "electrical" },
  { name: "Carrier Assembly", slug: "carrier-assembly", status: "In Stock", category: "drivetrain" },
  { name: "Clutch Master Cylinder", slug: "clutch-master-cylinder", status: "In Stock", category: "transmissions" },
  { name: "Column Switch", slug: "column-switch", status: "In Stock", category: "electrical" },
  { name: "Control Arm Front", slug: "control-arm-front", status: "In Stock", category: "suspension" },
  { name: "Control Arm Rear", slug: "control-arm-rear", status: "In Stock", category: "suspension" },
  { name: "Convertible Top Motor", slug: "convertible-top-motor", status: "In Stock", category: "electrical" },
  { name: "Cylinder Head", slug: "cylinder-head", status: "In Stock", category: "engines" },
  { name: "Differential Assembly", slug: "differential-assembly", status: "In Stock", category: "drivetrain" },
  { name: "Drive Shaft Front", slug: "drive-shaft-front", status: "In Stock", category: "drivetrain" },
  { name: "Drive Shaft Rear", slug: "drive-shaft-rear", status: "In Stock", category: "drivetrain" },
  { name: "Electric Door Motor", slug: "electric-door-motor", status: "In Stock", category: "electrical" },
  { name: "Exhaust Manifold", slug: "exhaust-manifold", status: "In Stock", category: "exhaust" },
  { name: "Fan Blade", slug: "fan-blade", status: "In Stock", category: "cooling" },
  { name: "Flywheel", slug: "flywheel", status: "In Stock", category: "engines" },
  { name: "Fuel Pump", slug: "fuel-pump", status: "In Stock", category: "engines" },
  { name: "GPS Screen", slug: "gps-screen", status: "In Stock", category: "electrical" },
  { name: "Heater Controls", slug: "heater-controls", status: "In Stock", category: "electrical" },
  { name: "Intake Manifold", slug: "intake-manifold", status: "In Stock", category: "engines" },
  { name: "Oil Pan Engine", slug: "oil-pan-engine", status: "In Stock", category: "engines" },
  { name: "Power Brake Booster", slug: "power-brake-booster", status: "In Stock", category: "brakes" },
  { name: "Rear Knuckle", slug: "rear-knuckle", status: "In Stock", category: "suspension" },
  { name: "Speedometer", slug: "speedometer", status: "In Stock", category: "electrical" },
  { name: "Spindle", slug: "spindle", status: "In Stock", category: "suspension" },
  { name: "Steering Column", slug: "steering-column", status: "In Stock", category: "suspension" },
  { name: "Steering Rack", slug: "steering-rack", status: "In Stock", category: "suspension" },
  { name: "Strut", slug: "strut", status: "In Stock", category: "suspension" },
  { name: "Throttle Body", slug: "throttle-body", status: "In Stock", category: "engines" },
  { name: "Timing Cover", slug: "timing-cover", status: "In Stock", category: "engines" },
  { name: "Torsion Bar", slug: "torsion-bar", status: "In Stock", category: "suspension" },
  { name: "Turbo Charger", slug: "turbo-charger", status: "In Stock", category: "engines" },
  { name: "Window Regulator Front", slug: "window-regulator-front", status: "In Stock", category: "electrical" },
  { name: "Window Regulator Quarter", slug: "window-regulator-quarter", status: "In Stock", category: "electrical" },
  { name: "Window Regulator Rear", slug: "window-regulator-rear", status: "In Stock", category: "electrical" },
  { name: "Wiper Motor", slug: "wiper-motor", status: "In Stock", category: "electrical" },
  { name: "Alternator", slug: "alternator", status: "In Stock", category: "electrical" },
  { name: "Starter Motor", slug: "starter-motor", status: "In Stock", category: "electrical" },
  { name: "Radiator", slug: "radiator", status: "In Stock", category: "cooling" },
  { name: "Water Pump", slug: "water-pump", status: "In Stock", category: "cooling" },
  { name: "ECU / PCM Module", slug: "ecu-pcm-module", status: "In Stock", category: "electrical" },
  { name: "Door Assembly", slug: "door-assembly", status: "In Stock", category: "body" },
  { name: "Hood", slug: "hood", status: "In Stock", category: "body" },
  { name: "Front Bumper", slug: "front-bumper", status: "In Stock", category: "body" },
  { name: "Rear Bumper", slug: "rear-bumper", status: "In Stock", category: "body" },
  { name: "Fender", slug: "fender", status: "In Stock", category: "body" },
  { name: "Headlight Assembly", slug: "headlight-assembly", status: "In Stock", category: "electrical" },
  { name: "Tail Light Assembly", slug: "tail-light-assembly", status: "In Stock", category: "electrical" },
  { name: "Dashboard", slug: "dashboard", status: "In Stock", category: "body" },
  { name: "Seat Assembly", slug: "seat-assembly", status: "In Stock", category: "body" },
  { name: "Door Mirror", slug: "door-mirror", status: "In Stock", category: "body" },
  { name: "Quarter Panel", slug: "quarter-panel", status: "In Stock", category: "body" },
  { name: "Tailgate", slug: "tailgate", status: "In Stock", category: "body" },
  { name: "Airbag Module", slug: "airbag-module", status: "In Stock", category: "electrical" },
  { name: "Instrument Cluster", slug: "instrument-cluster", status: "In Stock", category: "electrical" },
  { name: "Brake Caliper", slug: "brake-caliper", status: "In Stock", category: "brakes" },
  { name: "Catalytic Converter", slug: "catalytic-converter", status: "In Stock", category: "exhaust" },
  { name: "Oxygen Sensor", slug: "oxygen-sensor", status: "In Stock", category: "exhaust" },
  { name: "Mass Air Flow Sensor", slug: "mass-air-flow-sensor", status: "In Stock", category: "electrical" },
  { name: "Ignition Coil", slug: "ignition-coil", status: "In Stock", category: "electrical" },
  { name: "Fuel Injector", slug: "fuel-injector", status: "In Stock", category: "engines" },
  { name: "CV Axle", slug: "cv-axle", status: "In Stock", category: "drivetrain" },
  { name: "Torque Converter", slug: "torque-converter", status: "In Stock", category: "transmissions" },
  { name: "CV Pump", slug: "cv-pump", status: "In Stock", category: "drivetrain" },
]

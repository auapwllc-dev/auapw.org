      ...
      <div className="relative z-10 text-center px-6 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link 
            ...
            className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full bg-zinc-800 border border-zinc-600 text-white font-bold text-sm tracking-wide transition-all duration-200 hover:-translate-y-1 hover:bg-zinc-700 hover:border-zinc-500"
          >
        ...
        <section className="mx-auto max-w-7xl px-6 pb-16">
          <div className="rounded-2xl p-8 md:p-12 text-center" style={{ background: `linear-gradient(135deg, ${color}dd, ${color}aa)` }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                href="/quote" 
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-zinc-800 border border-zinc-600 text-white font-bold text-sm tracking-wide transition-all duration-200 hover:-translate-y-1 hover:bg-zinc-700"
              >
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {["Engine", "Transmission", "AC Compressor", "Radiator", "Alternator", "Starter Motor"].map((part) => (
                  <Link
                    ...
                    className="px-4 py-2 rounded-full bg-black/30 border border-white/20 text-xs font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-black/40"
                  >
                    {part}
                  </Link>
                ))}

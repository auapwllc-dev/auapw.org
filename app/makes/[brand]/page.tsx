    ...
    >
      ...
      <div className="relative z-10 text-center px-6 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {/* Search Parts - Matte Button */}
          <Link 
            href={`/search?make=${encodeURIComponent(brand)}`}
            className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800 border border-zinc-600 text-white font-semibold rounded-lg hover:bg-zinc-700 hover:border-zinc-500 transition-all"
          >
            <Search className="w-5 h-5" />
            Search {brand} Parts
          </Link>

          {/* Call Now - Matte Button */}
          <a 
            href={`tel:${PHONE_SALES.replace(/-/g, "")}`}
            className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-800/50 border border-zinc-600/50 text-white font-semibold rounded-lg hover:bg-zinc-700/50 hover:border-zinc-500/50 transition-all"
          >
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background pt-[58px]">
        ...
        {/* CTA Section - Clean Matte Style */}
        <section className="mx-auto max-w-7xl px-6 pb-16">
          <div className="rounded-2xl p-8 md:p-12 text-center" style={{ background: `linear-gradient(135deg, ${color}cc, ${color}99)` }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                href="/quote" 
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-white/90 transition-all"
              >
              ...
              <a 
                href={`tel:${PHONE_SALES.replace(/-/g, "")}`}
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 border border-white/30 text-white font-semibold rounded-lg hover:bg-white/20 transition-all"
              >
                <Phone className="w-5 h-5" />
                {PHONE_DISPLAY}
              </a>
            ...
            <div className="mt-8 pt-6 border-t border-white/20">
              <p className="text-white/60 text-sm mb-3">Popular {brand} Parts:</p>
              <div className="flex flex-wrap justify-center gap-2">
                {["Engine", "Transmission", "AC Compressor", "Radiator", "Alternator", "Starter Motor"].map((part) => (
                  <Link
                    ...
                    className="px-4 py-2 text-xs font-medium text-white bg-white/10 border border-white/20 rounded-full hover:bg-white/20 transition-all"
                  >
                    {part}
                  </Link>
                ))}

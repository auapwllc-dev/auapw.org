        ...
        <div className="mx-auto w-full px-3 sm:px-4 md:px-6 lg:px-8 flex items-center h-full justify-between gap-2 sm:gap-4 relative z-10">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <div className="flex items-center gap-2 sm:hidden">
              <a href="tel:8888185001" className="flex items-center justify-center w-8 h-8 hover:opacity-80 transition-opacity">
                <img src="/images/icon-phone-metallic.png" alt="Call" className="w-6 h-6 object-contain" />
              </a>
              <a href="mailto:support@auapw.org" className="flex items-center justify-center w-8 h-8 hover:opacity-80 transition-opacity">
                <img src="/images/icon-email-envelope.png" alt="Email" className="w-6 h-6 object-contain" />
              </a>
            </div>
          ...
          <div className="header-boss-mobile-drawer z-50">
            <div className="px-4 py-4 flex flex-col gap-2 max-h-[80vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-2 gap-2 mt-1">
                <a href="tel:8888185001" className="flex items-center justify-center p-2 rounded-lg hover:opacity-80 transition-opacity overflow-hidden">
                  <img src="/images/button-call-now.png" alt="Call Now" className="w-full h-auto" />
                </a>

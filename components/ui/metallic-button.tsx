...
export function EmailUsButton({ email = "support@auapw.org", className }: { email?: string; className?: string }) {
  return (
    <MetallicButton href={`mailto:${email}`} variant="silver" size="md" className={className}>
      <svg className="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
      <span className="text-black">{email} | Email Us</span>
    </MetallicButton>
  )
}
...
export function LocationButton({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <span className="flex flex-col items-start leading-tight text-black">
...
export function CallNowButton({ className }: { className?: string }) {
  return (
    <MetallicButton href="tel:8888185001" variant="silver" size="md" className={className}>
      <svg className="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
      </svg>
      <span className="text-black">Call (888) 818-5001</span>
    </MetallicButton>
  )
}

...
export function GearBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">
      ...
      >
        <Settings className="w-80 h-80 text-zinc-500 opacity-20" strokeWidth={0.5} />
      </div>
      ...
      >
        <Settings className="w-96 h-96 text-zinc-500 opacity-15" strokeWidth={0.5} />
      </div>
      ...
      >
        <Settings className="w-56 h-56 text-zinc-400 opacity-25" strokeWidth={0.5} />
      </div>
      ...
      >
        <Settings className="w-40 h-40 text-zinc-500 opacity-18" strokeWidth={0.5} />
      </div>
      ...
      >
        <Settings className="w-32 h-32 text-zinc-400 opacity-20" strokeWidth={0.5} />
      </div>
    </div>
  )
}

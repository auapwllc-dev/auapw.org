  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative">
          ...
          <div className="mx-auto max-w-7xl px-6 py-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={label} className="flex items-center gap-3 p-3 rounded-xl bg-background/50 border border-border/20">
        ...
        {/* Brand Logos Strip */}
        <div className="border-b border-border/20 bg-background/30 py-4">
          <div className="mx-auto max-w-7xl px-6">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-xs font-bold tracking-widest uppercase text-muted-foreground">Popular Brands</span>
              <div className="flex-1 h-px bg-border/30" />
              <Link href="/makes" className="text-xs font-bold text-primary hover:underline flex items-center gap-1">
            ...
            <div className="flex flex-wrap gap-2">
              {CAR_MAKES.slice(0, 14).map((brand) => (
                <Link
                  ...
                  className="flex items-center gap-2 px-3 py-2 rounded-lg bg-card/50 hover:bg-card border border-border/30 hover:border-primary/30 transition-all group"
                  title={`${brand} Parts`}
                >
                  <BrandLogo brand={brand} />
                  <span className="text-xs font-bold text-muted-foreground group-hover:text-foreground hidden sm:block">
                    {brand}
                  </span>
                </Link>
              ))}
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-sm text-muted-foreground dark:text-muted-foreground light:text-gray-700 leading-relaxed mb-6">
            ...
            <div className="lg:col-span-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                {/* Popular Parts */}
                <div className="relative p-5 rounded-2xl bg-card/30 border border-border/20 overflow-hidden">
                  {/* Background Icon */}
                  <svg className="absolute -right-4 -bottom-4 w-24 h-24 text-primary/5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <h3 className="relative text-xs font-bold tracking-widest uppercase text-foreground dark:text-foreground light:text-gray-900 mb-4 pb-3 border-b border-border/30">
                    Popular Parts
                  </h3>
                    ...
                    {popularParts.map((part) => (
                      <li key={part}>
                        <Link 
                          ...
                          className="text-sm text-muted-foreground dark:text-muted-foreground light:text-gray-700 hover:text-primary transition-colors flex items-center gap-2"
                        >
        ...
        <div className="border-t border-border/30 bg-card/50 backdrop-blur-sm">
          <div className="mx-auto max-w-7xl px-6 py-5">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-muted-foreground dark:text-muted-foreground light:text-gray-700 text-center sm:text-left">
                &copy; {new Date().getFullYear()} <span className="font-bold text-foreground">AUAPW.ORG</span> — All Used Auto Parts World. All Rights Reserved.
              </p>
              <div className="flex items-center gap-4 text-xs text-muted-foreground dark:text-muted-foreground light:text-gray-700">
